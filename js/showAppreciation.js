window.onload = (function () {
    ...
    const data = [
        ...
        { name: '*民', color: MCO['2'], money: '50.00', date: '2025/10/11' },
        { name: '*🐵', color: MCO['3'], money: '35.00', date: '2023/11/20' },
        { name: '我是当地皮鞋', color: MCO['3'], money: '30.00', date: '2025/06/05' },
        { name: '课课小天地', color: MCO['3'], money: '28.88', date: '2025/09/13' },
        { name: 'H*H', color: MCO['4'], money: '25.00', date: '2026/03/22' },
        { name: '虚空漫游c', color: MCO['4'], money: '25.00', date: '2025/10/12' },
        { name: '加载中······', color: MCO['4'], money: '20.00', date: '2024/10/08' },
        { name: '*雨', color: MCO['4'], money: '20.00', date: '2026/01/06' },
        ...
        { name: '**蔚', color: MCO['4'], money: '18.00', date: '2025/09/03' },
        { name: '鸡你太美', color: MCO['4'], money: '16.88', date: '2025/02/18' },
        ...
        { name: '**深', color: MCO['4'], money: '10.00', date: '2026/03/11' },
        { name: 'B*U', color: MCO['4'], money: '10.00', date: '2025/12/08' },
        ...
        { name: '大佬，我没啥钱，谢谢大佬', color: MCO['4'], money: '10.00', date: '2025/03/18' },
        ...
        { name: '聖園ミ力', color: MCO['5'], money: '6.66', date: '2026/03/12' },
        { name: '怅然返', color: MCO['5'], money: '6.66', date: '2025/10/31' },
        ...
        { name: '*茗', color: MCO['5'], money: '5.00', date: '2025/10/17' },
        { name: '*5', color: MCO['5'], money: '5.00', date: '2025/09/06' },
        ...
        { name: '*民', color: MCO['6'], money: '4.00', date: '2025/12/08' },
        { name: '鹤川', color: MCO['6'], money: '3.00', date: '2024/12/11' },
        { name: '好先生', color: MCO['6'], money: '3.00', date: '2024/04/14' },
        { name: '鱼染', color: MCO['7'], money: '2.00', date: '2026/03/22' },
        { name: '*诀', color: MCO['7'], money: '2.00', date: '2025/06/02' },
        { name: '**显', color: MCO['7'], money: '1.00', date: '2025/09/11' },
        { name: '*霸', color: MCO['7'], money: '1.00', date: '2025/05/03' },
